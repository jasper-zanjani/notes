...
##### Network topology
Set static IPs for three interfaces belonging to **PLABDM01**
```powershell
New-NetIpAddress 192.168.0.20 -PrefixLength 24 -InterfaceAlias Ethernet1
...
```
Make similar changes to **PLABSA01**
```powershell
New-NetIpAddress 192.168.0.40 -PrefixLength 24 -InterfaceAlias Ethernet1
...
Install iSCSI Target Server on **PLABDC01**
```powershell
...
```
Then validate the installation through Server Manager > Tools > **Failover Cluster Manager**. <sup>[🖼](img/image-m17-c-83.jpg)</sup>