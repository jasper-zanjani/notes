...
- [ ] [**5**](#clusters) Implement high availability
  - [x] [5.1][5.1] Implement high availability and disaster recovery options in Hyper-V
  - [ ] [5.2][5.2] Implement failover clustering
  - [x] [5.3][5.3] Implement Storage Spaces Direct
...
These disks be [thinly provisioned][thinly provisioned], if the drive is expected to grow in the future.
Storage Spaces also has a featured called [tiered storage][tiered storage]
