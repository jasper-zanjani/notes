...
[Active Directory][AD] has its origins in 1990 when Microsoft released Windows NT 3.0, its first Network Operating System (NOS). To address NT's shortcomings, they re-architected the solution to be based on LDAP.
...
Active Directory, like its predecessor WinNT, provides directory services
