...
High-performance [embedded teaming][SET], which relies on [RDMA][RDMA], can only be configured with [Powershell](pwsh.md#create-a-virtual-switch-with-set-enabled).
