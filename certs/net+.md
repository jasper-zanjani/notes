...
1.7 | Summmarize cloud concepts and their purposes
...
Term                                                        | Definition
:---                                                        | :---
Address Resolution Protocol (ARP)                           | defined in RFC 826, responsible for resolving IP addresses to MAC addresses
...
Hypertext Transfer Protocol (HTTP)                          | defined in RFC 2068, protocol that enables text, graphics, multimedia, and other material to be downloaded from an HTTP server
Hypertext Transfer Protocol Secure (HTTPS)                  |  [[1](#sources): 48]
Internet Control Message Protocol (ICMP)                    | defined in RFC 792, provides error checking and reporting functionality, in particular in association with ping
...
Network Time Protocol (NTP)                                 | defined in RFC 958, facilitaties time synchronization [[1](#sources): 51-52]
