...
Web Service Description Language (WSDL) | markup language used for API of a web service | 5PLC: 17
...
Brigade             | event-driven scripting tool for Kubernetes | 5PLC: 24
Draft               | tool that makes it easy to develop container-based applications and to deploy them to Kubernetes clusters | 5PLC: 24
Microsoft Web Application Firewall (WAF) | feature of __Azure Application Gateway__ | 5PLC: 43
