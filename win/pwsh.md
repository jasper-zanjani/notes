...
ADA | **`ADAccount`** [`sr`][Search-ADAccount] [`uk`][Unlock-ADAccount] &bull; **`ADAccountPassword`** [`s`][Set-ADAccountPassword]
ADD | **`ADDSDomain`** [`is`][Install-ADDSDomain] &bull; **`ADDSDomainController`** [`us`][Uninstall-ADDSDomainController] &bull; **`ADDSForest`** [`g`][Get-ADDSForest] [`is`][Install-ADDSForest]
ADO | **`ADObject`** [`s`][Set-ADObject] &bull; **`ADOrganizationalUnit`** [`g`][Get-ADOrganizationalUnit] [`n`][New-ADOrganizationalUnit] [`r`][Remove-ADOrganizationalUnit] [`s`][Set-ADOrganizationalUnit]
...
**G** | **`Guid`** [`n`][New-Guid]
**H** | **`Help`** [`g`][Get-Help] [`ud`][Update-Help]
**I** | **`Item`** [`Copy`][Copy-Item] [`g`][Get-Item] [`n`][New-Item] [`r`][Remove-Item]
**L** | **`List`** [`f`][Format-List] &bull; **`Location`** [`g`][Get-Location] [`s`][Set-Location]
...
**S** | **`Service`** [`g`][Get-Service] [`sa`][Start-Service] [`sp`][Stop-Service] &bull; **`SmbShare`** [`n`][New-SmbShare]
**T** | **`Table`** [`f`][Format-Table]
