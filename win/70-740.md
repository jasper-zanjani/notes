...
[**Data deduplication**][Data deduplication] is a role service that conserves storage space on an NTFS volume by storing only one copy of redundant chunks of files.
