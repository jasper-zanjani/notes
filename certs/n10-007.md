...
\#    | Title | Description
:---  | :---  | :---
1.1 | [**DHCP**](#dhcp) [**DNS**](#dns) [FTP](#glossary) [H.323](#sources) [HTTP](#glossary) [**ICMP**](#icmp) IMAP [**IP**](#ip) [**LDAP/S**](#ldap) [ NTP ](#glossary) POP RDDP SFTP SIP SMB SMTP SNMP SSH TCP TELNET TFTP UDP
1.2 | [OSI model](#osi-model) 
...
2.2 | Given a scenario, determine the appropriate placement of networking devices on a network and install/configure them | Firewall, Router, Switch, Hub, Bridge, Modems, WAP, Media converter, Wireless range extender, VoIP endpo#int
...
There are various ways of adjusting the functionality of switch interfaces: [[1](#sources): 363]
