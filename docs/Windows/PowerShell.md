...
[`Add`][Add-CAAuthorityInformationAccess][?][msdocs:Add-CAAuthorityInformationAccess]
[`Get`][Get-CAAuthorityInformationAccess][?][msdocs:Get-CAAuthorityInformationAccess]
[`Remove`][Remove-CAAuthorityInformationAccess][?][msdocs:Remove-CAAuthorityInformationAccess]
- CACrlDistributionPoint
[`Add`][Add-CACrlDistributionPoint][?][msdocs:Add-CACrlDistributionPoint]
[`Get`][Get-CACrlDistributionPoint][?][msdocs:Get-CACrlDistributionPoint]
[`Remove`][Remove-CACrlDistributionPoint][?][msdocs:Remove-CACrlDistributionPoint]
- CAEndorsementKeyInfo
[`Confirm`][Confirm-CAEndorsementKeyInfo][?][msdocs:Confirm-CAEndorsementKeyInfo]
- CARoleService
[`Backup`][Backup-CARoleService][?][msdocs:Backup-CARoleService]
[`Restore`][Restore-CARoleService][?][msdocs:Restore-CARoleService]
- [CATemplate][certificate template]
[`Add`][Add-CATemplate][?][msdocs:Add-CATemplate]
[`Get`][Get-CATemplate][?][msdocs:Get-CATemplate]
[`Remove`][Remove-CATemplate][?][msdocs:Remove-CATemplate]
#### adcsdeployment
...
[**`Install`**][Install-AdcsCertificationAuthority][?][msdocs:Install-AdcsCertificationAuthority]
[`Uninstall`][Uninstall-AdcsCertificationAuthority][?][msdocs:Uninstall-AdcsCertificationAuthority]
- AdcsEnrollmentPolicyWebService
[`Install`][Install-AdcsEnrollmentPolicyWebService][?][msdocs:Install-AdcsEnrollmentPolicyWebService]
[`Uninstall`][Uninstall-AdcsEnrollmentPolicyWebService][?][msdocs:Uninstall-AdcsEnrollmentPolicyWebService]
- AdcsEnrollmentWebService
[`Install`][Install-AdcsEnrollmentWebService][?][msdocs:Install-AdcsEnrollmentWebService]
[`Uninstall`][Uninstall-AdcsEnrollmentWebService][?][msdocs:Uninstall-AdcsEnrollmentWebService]
- AdcsNetworkDeviceEnrollmentService
[`Install`][Install-AdcsNetworkDeviceEnrollmentService][?][msdocs:Install-AdcsNetworkDeviceEnrollmentService]
[`Uninstall`][Uninstall-AdcsNetworkDeviceEnrollmentService][?][msdocs:Uninstall-AdcsNetworkDeviceEnrollmentService]
- AdcsOnlineResponder
[`Install`][Install-AdcsOnlineResponder][?][msdocs:Install-AdcsOnlineResponder]
[`Uninstall`][Uninstall-AdcsOnlineResponder][?][msdocs:Uninstall-AdcsOnlineResponder]
- AdcsWebEnrollment
[`Install`][Install-AdcsWebEnrollment][?][msdocs:Install-AdcsWebEnrollment]
[`Uninstall`][Uninstall-AdcsWebEnrollment][?][msdocs:Uninstall-AdcsWebEnrollment]
#### addsadministration
...
- ADAccount
[`Disable`][Disable-ADAccount][?][msdocs:Disable-ADAccount]
[`Enable`][Enable-ADAccount][?][msdocs:Enable-ADAccount]
[`Search`][Search-ADAccount][?][msdocs:Search-ADAccount]
[`Unlock`][Unlock-ADAccount][?][msdocs:Unlock-ADAccount]
- ADAccountPassword
[`Set`][Set-ADAccountPassword][?][msdocs:Set-ADAccountPassword]
- ADForest
[`Get`][Get-ADForest][?][msdocs:Get-ADForest]
[`Set`][Set-ADForest][?][msdocs:Set-ADForest]
- ADGroup
[`Get`][Get-ADGroup][?][msdocs:Get-ADGroup]
[`New`][New-ADGroup][?][msdocs:New-ADGroup]
[`Remove`][Remove-ADGroup][?][msdocs:Remove-ADGroup]
[`Set`][Set-ADGroup][?][msdocs:Set-ADGroup]
- ADGroupMember
[`Add`][Add-ADGroupMember][?][msdocs:Add-ADGroupMember]
[`Get`][Get-ADGroupMember][?][msdocs:Get-ADGroupMember]
[`Remove`][Remove-ADGroupMember][?][msdocs:Remove-ADGroupMember]
- ADObject
[`Move`][Move-ADObject][?][msdocs:Move-ADObject]
[`New`][New-ADObject][?][msdocs:New-ADObject]
[`Remove`][Remove-ADObject][?][msdocs:Remove-ADObject]
[`Rename`][Rename-ADObject][?][msdocs:Rename-ADObject]
[`Restore`][Restore-ADObject][?][msdocs:Restore-ADObject]
[`Set`][Set-ADObject][?][msdocs:Set-ADObject]
[`Sync`][Sync-ADObject][?][msdocs:Sync-ADObject]
- ADOrganizationalUnit
[`Get`][Get-ADOrganizationalUnit][?][msdocs:Get-ADOrganizationalUnit]
[`New`][New-ADOrganizationalUnit][?][msdocs:New-ADOrganizationalUnit]
[`Remove`][Remove-ADOrganizationalUnit][?][msdocs:Remove-ADOrganizationalUnit]
[`Set`][Set-ADOrganizationalUnit][?][msdocs:Set-ADOrganizationalUnit]
- ADPrincipalGroupMembership
[`Add`][Add-ADPrincipalGroupMembership][?][msdocs:Add-ADPrincipalGroupMembership]
[`Get`][Get-ADPrincipalGroupMembership][?][msdocs:Get-ADPrincipalGroupMembership]
[`Remove`][Remove-ADPrincipalGroupMembership][?][msdocs:Remove-ADPrincipalGroupMembership]
- ADUser
[`Get`][Get-ADUser][?][msdocs:Get-ADUser]
[`New`][New-ADUser][?][msdocs:New-ADUser]
[`Remove`][Remove-ADUser][?][msdocs:Remove-ADUser]
[`Set`][Set-ADUser][?][msdocs:Set-ADUser]
#### addsdeployment
...
- ADDSDomain
[`Install`][Install-ADDSDomain][?][msdocs:Install-ADDSDomain]
- ADDSDomainController
[`Install`][Install-ADDSDomainController][?][msdocs:Install-ADDSDomainController]
[`Uninstall`][Uninstall-ADDSDomainController][?][msdocs:Uninstall-ADDSDomainController]
- ADDSForest
[**`Install`**][Install-ADDSForest][?][msdocs:Install-ADDSForest]
#### dcbqos
...
- NetQoSDcbxSetting 
`Get`[?][msdocs:Get-NetQosDcbxSetting]
[`Set`][Set-NetQosDcbxSetting][?][msdocs:Set-NetQosDcbxSetting]
`Switch`[?][msdocs:Switch-NetQosDcbxSetting]
- NetQoSFlowControl
`Enable`[?][msdocs:Enable-NetQosFlowControl]
`Disable`[?][msdocs:Disable-NetQosFlowControl]
`Get`[?][msdocs:Get-NetQosFlowControl]
`Set`[?][msdocs:Set-NetQosFlowControl]
`Switch`[?][msdocs:Switch-NetQosFlowControl]
- NetQoSTrafficClass
`Get`[?][msdocs:Get-NetQosTrafficClass]
`New`[?][msdocs:New-NetQosTrafficClass]
`Remove`[?][msdocs:Remove-NetQosTrafficClass]
`Set`[?][msdocs:Set-NetQosTrafficClass]
`Switch`[?][msdocs:Switch-NetQosTrafficClass]
#### deduplication
...
- DedupVolume 
[`Get`][Get-DedupStatus][?][msdocs:Get-DedupStatus]
[`Update`][Update-DedupStatus][?][msdocs:Update-DedupStatus]
[`Disable`][Disable-DedupVolume][?][msdocs:Disable-DedupVolume]
[**`Enable`**][Enable-DedupVolume][?][msdocs:Enable-DedupVolume]
[`Get`][Get-DedupVolume][?][msdocs:Get-DedupVolume]
[**`Set`**][Set-DedupVolume][?][msdocs:Set-DedupVolume]
#### defender
...
- MpScan [`Start`][Start-MpScan][?][msdocs:Start-MpScan]
- MpThreat [`Get`][Get-MpThreat][?][msdocs:Get-MpThreat] [`Remove`][Remove-MpThreat][?][msdocs:Remove-MpThreat]
#### dhcpserver
...
- DHCPServerInDC 
[`Add`][Add-DhcpServerInDC][?][msdocs:Add-DhcpServerInDC]
- DHCPServerv4Scope 
[`Add`][Add-DhcpServerv4Scope][?][msdocs:Add-DhcpServerv4Scope]
[`Get`][Get-DhcpServerv4Scope][?][msdocs:Get-DhcpServerv4Scope]
[`Remove`][Remove-DhcpServerv4Scope][?][msdocs:Remove-DhcpServerv4Scope]
[`Set`][Set-DhcpServerv4Scope][?][msdocs:Set-DhcpServerv4Scope]
- DHCPServerv4OptionValue 
[`Set`][Set-DhcpServerv4OptionValue][?][msdocs:Set-DhcpServerv4OptionValue]
#### dism
...
[`Set`][Set-AppxProvisionedDataFile][?][msdocs:Set-AppxProvisionedDataFile]
- AppxProvisionedPackage
[`Add`][Add-AppxProvisionedPackage][?][msdocs:Add-AppxProvisionedPackage]
[`Get`][Get-AppxProvisionedPackage][?][msdocs:Get-AppxProvisionedPackage]
[`Remove`][Remove-AppxProvisionedPackage][?][msdocs:Remove-AppxProvisionedPackage]
- WIMBootEntry
[`Get`][Get-WIMBootEntry][?][msdocs:Get-WIMBootEntry]
[`Update`][Update-WIMBootEntry][?][msdocs:Update-WIMBootEntry]
- WindowsCapability
[`Add`][Add-WindowsCapability][?][msdocs:Add-WindowsCapability]
[`Get`][Get-WindowsCapability][?][msdocs:Get-WindowsCapability]
[`Remove`][Remove-WindowsCapability][?][msdocs:Remove-WindowsCapability]
- WindowsCorruptMountPoint
[`Clear`][Clear-WindowsCorruptMountPoint][?][msdocs:Clear-WindowsCorruptMountPoint]
- WindowsCustomDataImage
[`Expand`][Expand-WindowsCustomDataImage][?][msdocs:Expand-WindowsCustomDataImage]
- WindowsCustomImage
[`New`][New-WindowsCustomImage][?][msdocs:New-WindowsCustomImage]
- WindowsDriver
[`Add`][Add-WindowsDriver][?][msdocs:Add-WindowsDriver]
[`Export`][Export-WindowsDriver][?][msdocs:Export-WindowsDriver]
[`Get`][Get-WindowsDriver][?][msdocs:Get-WindowsDriver]
[`Remove`][Remove-WindowsDriver][?][msdocs:Remove-WindowsDriver]
- WindowsEdition
[`Get`][Get-WindowsEdition][?][msdocs:Get-WindowsEdition]
[`Set`][Set-WindowsEdition][?][msdocs:Set-WindowsEdition]
- WindowsImage
[`Add`][Add-WindowsImage][?][msdocs:Add-WindowsImage]
[`Dismount`][Dismount-WindowsImage][?][msdocs:Dismount-WindowsImage]
[`Expand`][Expand-WindowsImage][?][msdocs:Expand-WindowsImage]
[`Export`][Export-WindowsImage][?][msdocs:Export-WindowsImage]
[`Get`][Get-WindowsImage][?][msdocs:Get-WindowsImage]
[`Mount`][Mount-WindowsImage][?][msdocs:Mount-WindowsImage]
[`New`][New-WindowsImage][?][msdocs:New-WindowsImage]
[`Optimize`][Optimize-WindowsImage][?][msdocs:Optimize-WindowsImage]
[`Remove`][Remove-WindowsImage][?][msdocs:Remove-WindowsImage]
[`Repair`][Repair-WindowsImage][?][msdocs:Repair-WindowsImage]
[`Save`][Save-WindowsImage][?][msdocs:Save-WindowsImage]
[`Split`][Split-WindowsImage][?][msdocs:Split-WindowsImage]
- WindowsImageContent
[`Get`][Get-WindowsImageContent][?][msdocs:Get-WindowsImageContent]
- WindowsOptionalFeature
[`Disable`][Disable-WindowsOptionalFeature][?][msdocs:Disable-WindowsOptionalFeature]
[`Enable`][Enable-WindowsOptionalFeature][?][msdocs:Enable-WindowsOptionalFeature]
[`Get`][Get-WindowsOptionalFeature][?][msdocs:Get-WindowsOptionalFeature]
- WindowsPackage
[`Add`][Add-WindowsPackage][?][msdocs:Add-WindowsPackage]
[`Get`][Get-WindowsPackage][?][msdocs:Get-WindowsPackage]
[`Remove`][Remove-WindowsPackage][?][msdocs:Remove-WindowsPackage]
- WindowsProductKey
[`Set`][Set-WindowsProductKey][?][msdocs:Set-WindowsProductKey]
- WindowsReservedStorageState
[`Get`][Get-WindowsReservedStorageState][?][msdocs:Get-WindowsReservedStorageState]
[`Set`][Set-WindowsReservedStorageState][?][msdocs:Set-WindowsReservedStorageState]
- WindowsUnattend
[`Apply`][Apply-WindowsUnattend][?][msdocs:Apply-WindowsUnattend]
[`Use`][Use-WindowsUnattend][?][msdocs:Use-WindowsUnattend]
#### dnsclient
...
[`Get`][Get-DnsClientServerAddress][?][msdocs:Get-DnsClientServerAddress]
[**`Set`**][Set-DnsClientServerAddress][?][msdocs:Set-DnsClientServerAddress]
- DnsName
[`Resolve`][Resolve-DnsName][?][msdocs:Resolve-DnsName]
#### dnsserver
...
[**`Add`**][Add-DnsServerConditionalForwarderZone][?][msdocs:Add-DnsServerConditionalForwarderZone]
[`Set`][Set-DnsServerConditionalForwarderZone][?][msdocs:Set-DnsServerConditionalForwarderZone]
- DnsServer[Forwarder][forwarder]
[**`Add`**][Add-DnsServerForwarder][?][msdocs:Add-DnsServerForwarder]
[`Get`][Get-DnsServerForwarder][?][msdocs:Get-DnsServerForwarder]
[`Remove`][Remove-DnsServerForwarder][?][msdocs:Remove-DnsServerForwarder]
[`Set`][Set-DnsServerForwarder][?][msdocs:Set-DnsServerForwarder]
- DnsServerPrimaryZone
[**`Add`**][Add-DnsServerPrimaryZone][?][msdocs:Add-DnsServerPrimaryZone]
[`ConvertTo`][ConvertTo-DnsServerPrimaryZone][?][msdocs:ConvertTo-DnsServerPrimaryZone]
[`Restore`][Restore-DnsServerPrimaryZone][?][msdocs:Restore-DnsServerPrimaryZone]
[`Set`][Set-DnsServerPrimaryZone][?][msdocs:Set-DnsServerPrimaryZone]
- DnsServerSecondaryZone
[`Add`][Add-DnsServerSecondaryZone][?][msdocs:Add-DnsServerSecondaryZone]
[`ConvertTo`][ConvertTo-DnsServerSecondaryZone][?][msdocs:ConvertTo-DnsServerSecondaryZone]
[`Restore`][Restore-DnsServerSecondaryZone][?][msdocs:Restore-DnsServerSecondaryZone]
[`Set`][Set-DnsServerSecondaryZone][?][msdocs:Set-DnsServerSecondaryZone]
- DnsServerZone
[`Export`][Export-DnsServerZone][?][msdocs:Export-DnsServerZone]
[`Get`][Get-DnsServerZone][?][msdocs:Get-DnsServerZone]
[`Remove`][Remove-DnsServerZone][?][msdocs:Remove-DnsServerZone]
[`Resume`][Resume-DnsServerZone][?][msdocs:Resume-DnsServerZone]
[`Suspend`][Suspend-DnsServerZone][?][msdocs:Suspend-DnsServerZone]
[`Sync`][Sync-DnsServerZone][?][msdocs:Sync-DnsServerZone]
- Dns ServerZoneDelegation
[**`Add`**][Add-DnsServerZoneDelegation][?][msdocs:Add-DnsServerZoneDelegation]
[`Get`][Get-DnsServerZoneDelegation][?][msdocs:Get-DnsServerZoneDelegation]
[`Remove`][Remove-DnsServerZoneDelegation][?][msdocs:Remove-DnsServerZoneDelegation]
[`Set`][Set-DnsServerZoneDelegation][?][msdocs:Set-DnsServerZoneDelegation]
#### failoverclusters
...
- Cluster
[`Get`][Get-Cluster][?][msdocs:Get-Cluster]
[`New`][New-Cluster][?][msdocs:New-Cluster]
[`Remove`][Remove-Cluster][?][msdocs:Remove-Cluster]
[`Start`][Start-Cluster][?][msdocs:Start-Cluster]
[`Stop`][Stop-Cluster][?][msdocs:Stop-Cluster]
[`Test`][Test-Cluster][?][msdocs:Test-Cluster]
- ClusterNode
[`Add`][Add-ClusterNode][?][msdocs:Add-ClusterNode]
[`Clear`][Clear-ClusterNode][?][msdocs:Clear-ClusterNode]
[`Get`][Get-ClusterNode][?][msdocs:Get-ClusterNode]
[`Remove`][Remove-ClusterNode][?][msdocs:Remove-ClusterNode]
[`Resume`][Resume-ClusterNode][?][msdocs:Resume-ClusterNode]
[`Start`][Start-ClusterNode][?][msdocs:Start-ClusterNode]
[`Stop`][Stop-ClusterNode][?][msdocs:Stop-ClusterNode]
[`Suspend`][Suspend-ClusterNode][?][msdocs:Suspend-ClusterNode]
- ClusterQuorum
[`Get`][Get-ClusterQuorum][?][msdocs:Get-ClusterQuorum]
[`Set`][Set-ClusterQuorum][?][msdocs:Set-ClusterQuorum]
- ClusterScaleOutFileServerRole
[**`Add`**][Add-ClusterScaleOutFileServerRole][?][msdocs:Add-ClusterScaleOutFileServerRole]
- ClusterSharedVolume
[**`Add`**][Add-ClusterSharedVolume][?][msdocs:Add-ClusterSharedVolume]
[`Get`][Get-ClusterSharedVolume][?][msdocs:Get-ClusterSharedVolume]
[`Move`][Move-ClusterSharedVolume][?][msdocs:Move-ClusterSharedVolume]
[`Remove`][Remove-ClusterSharedVolume][?][msdocs:Remove-ClusterSharedVolume]
- ClusterVirtualMachineRole
[**`Add`**][Add-ClusterVirtualMachineRole][?][msdocs:add-clustervirtualmachinerole]
- ClusterVMMonitoredItem
[`Add`][Add-ClusterVMMonitoredItem][?][msdocs:Add-ClusterVMMonitoredItem]
#### grouppolicy
...
- GPLink
[**`New`**][New-GPLink][?][msdocs:New-GPLink]
[`Remove`][Remove-GPLink][?][msdocs:Remove-GPLink]
[`Set`][Set-GPLink][?][msdocs:Set-GPLink]
- GPO
[**`Backup`**][Backup-GPO][?][msdocs:Backup-GPO]
[**`Copy`**][Copy-GPO][?][msdocs:Copy-GPO]
[`Get`][Get-GPO][?][msdocs:Get-GPO]
[**`Import`**][Import-GPO][?][msdocs:Import-GPO]
[**`New`**][New-GPO][?][msdocs:New-GPO]
[`Remove`][Remove-GPO][?][msdocs:Remove-GPO]
[`Rename`][Rename-GPO][?][msdocs:Rename-GPO]
[**`Restore`**][Restore-GPO][?][msdocs:Restore-GPO]
- GPPermission
[`Get`][Get-GPPermission][?][msdocs:Get-GPPermission]
[`Set`][Set-GPPermission][?][msdocs:Set-GPPermission]
- GPUpdate 
[`Invoke`][Invoke-GPUpdate][?][msdocs:Invoke-GPUpdate]
#### hyper-v
...
- VHD
[`Convert`][Convert-VHD][?][msdocs:Convert-VHD]
[`Dismount`][Dismount-VHD][?][msdocs:Dismount-VHD]
[`Merge`][Merge-VHD][?][msdocs:Merge-VHD]
[`Mount`][Mount-VHD][?][msdocs:Mount-VHD]
[`New`][New-VHD][?][msdocs:New-VHD]
[`Optimize`][Optimize-VHD][?][msdocs:Optimize-VHD]
[`Resize`][Resize-VHD][?][msdocs:Resize-VHD]
- VM
[`Checkpoint`][Checkpoint-VM][?][msdocs:Checkpoint-VM]
[`Compare`][Compare-VM][?][msdocs:Compare-VM]
[`Debug`][Debug-VM][?][msdocs:Debug-VM]
[`Export`][Export-VM][?][msdocs:Export-VM]
[`Get`][Get-VM][?][msdocs:Get-VM]
[`Import`][Import-VM][?][msdocs:Import-VM]
[`Measure`][Measure-VM][?][msdocs:Measure-VM]
[`Move`][Move-VM][?][msdocs:Move-VM]
[`New`][New-VM][?][msdocs:New-VM]
[`Optimize`][Optimize-VM][?][msdocs:Optimize-VM]
[`Remove`][Remove-VM][?][msdocs:Remove-VM]
[`Rename`][Rename-VM][?][msdocs:Rename-VM]
[`Repair`][Repair-VM][?][msdocs:Repair-VM]
[`Restart`][Restart-VM][?][msdocs:Restart-VM]
[`Resume`][Resume-VM][?][msdocs:Resume-VM]
[`Save`][Save-VM][?][msdocs:Save-VM]
[`Set`][Set-VM][?][msdocs:Set-VM]
[`Start`][Start-VM][?][msdocs:Start-VM]
[`Stop`][Stop-VM][?][msdocs:Stop-VM]
[`Suspend`][Suspend-VM][?][msdocs:Suspend-VM]
- VMDvdDrive
[`Add`][Add-VMDvdDrive][?][msdocs:Add-VMDvdDrive]
[`Get`][Get-VMDvdDrive][?][msdocs:Get-VMDvdDrive]
[`Remove`][Remove-VMDvdDrive][?][msdocs:Remove-VMDvdDrive]
[`Set`][Set-VMDvdDrive][?][msdocs:Set-VMDvdDrive]
- VMFirmware
[`Get`][Get-VMFirmware][?][msdocs:Get-VMFirmware]
[`Set`][Set-VMFirmware][?][msdocs:Set-VMFirmware]
- VMFibreChannelHba
[`Add`][Add-VMFibreChannelHba][?][msdocs:Add-VMFibreChannelHba]
[`Get`][Get-VMFibreChannelHba][?][msdocs:Get-VMFibreChannelHba]
[`Remove`][Remove-VMFibreChannelHba][?][msdocs:Remove-VMFibreChannelHba]
[`Set`][Set-VMFibreChannelHba][?][msdocs:Set-VMFibreChannelHba]
- VMHardDiskDrive
[`Add`][Add-VMHardDiskDrive][?][msdocs:Add-VMHardDiskDrive]
[`Get`][Get-VMHardDiskDrive][?][msdocs:Get-VMHardDiskDrive]
[`Remove`][Remove-VMHardDiskDrive][?][msdocs:Remove-VMHardDiskDrive]
[`Set`][Set-VMHardDiskDrive][?][msdocs:Set-VMHardDiskDrive]
- VMHost
[`Get`][Get-VMHost][?][msdocs:Get-VMHost]
[`Set`][Set-VMHost][?][msdocs:Set-VMHost]
- VMMemory
[`Get`][Get-VMMemory][?][msdocs:Get-VMMemory]
[`Set`][Set-VMMemory][?][msdocs:Set-VMMemory]
- VMMigration
[`Enable`][Enable-VMMigration][?][msdocs:Enable-VMMigration]
- VMMigrationNetwork
[**`Set`**][Set-VMMigrationNetwork][?][msdocs:Set-VMMigrationNetwork]
- VMNetworkAdapter
[`Add`][Add-VMNetworkAdapter][?][msdocs:Add-VMNetworkAdapter]
[`Connect`][Connect-VMNetworkAdapter][?][msdocs:Connect-VMNetworkAdapter]
[`Disconnect`][Disconnect-VMNetworkAdapter][?][msdocs:Disconnect-VMNetworkAdapter]
[`Get`][Get-VMNetworkAdapter][?][msdocs:Get-VMNetworkAdapter]
[`Remove`][Remove-VMNetworkAdapter][?][msdocs:Remove-VMNetworkAdapter]
[`Rename`][Rename-VMNetworkAdapter][?][msdocs:Rename-VMNetworkAdapter]
[`Set`][Set-VMNetworkAdapter][?][msdocs:Set-VMNetworkAdapter]
[`Test`][Test-VMNetworkAdapter][?][msdocs:Test-VMNetworkAdapter]
- VMProcessor
[`Get`][Get-VMProcessor][?][msdocs:Get-VMProcessor]
[`Set`][Set-VMProcessor][?][msdocs:Set-VMProcessor]
- VMReplication
[**`Enable`**][Enable-VMReplication][?][msdocs:Enable-VMReplication]
[`Get`][Get-VMReplication][?][msdocs:Get-VMReplication]
[`Measure`][Measure-VMReplication][?][msdocs:Measure-VMReplication]
[`Remove`][Remove-VMReplication][?][msdocs:Remove-VMReplication]
[`Resume`][Resume-VMReplication][?][msdocs:Resume-VMReplication]
[`Set`][Set-VMReplication][?][msdocs:Set-VMReplication]
[`Stop`][Stop-VMReplication][?][msdocs:Stop-VMReplication]
[`Suspend`][Suspend-VMReplication][?][msdocs:Suspend-VMReplication]
- VMReplicationServer
[`Get`][Get-VMReplicationServer][?][msdocs:Get-VMReplicationServer]
[**`Set`**][Set-VmReplicationServer][?][msdocs:Set-VmReplicationServer]
- VMSaN
[`Connect`][Connect-VMSan][?][msdocs:Connect-VMSan]
[`Disconnect`][Disconnect-VMSan][?][msdocs:Disconnect-VMSan]
[`Get`][Get-VMSan][?][msdocs:Get-VMSan]
[`New`][New-VMSan][?][msdocs:New-VMSan]
[`Remove`][Remove-VMSan][?][msdocs:Remove-VMSan]
[`Rename`][Rename-VMSan][?][msdocs:Rename-VMSan]
[`Set`][Set-VMSan][?][msdocs:Set-VMSan]
- VMSnapshot
[`Restore`][Restore-VMSnapshot][?][msdocs:Restore-VMSnapshot]
- VMSwitch
[`Add`][Add-VMSwitch][?][msdocs:Add-VMSwitch]
[`Get`][Get-VMSwitch][?][msdocs:Get-VMSwitch]
[`New`][New-VMSwitch][?][msdocs:New-VMSwitch]
[`Remove`][Remove-VMSwitch][?][msdocs:Remove-VMSwitch]
[`Rename`][Rename-VMSwitch][?][msdocs:Rename-VMSwitch]
[`Set`][Set-VMSwitch][?][msdocs:Set-VMSwitch]
- VMSwitchTeam
[`Get`][Get-VMSwitchTeam][?][msdocs:Get-VMSwitchTeam]
[`Set`][Set-VMSwitchTeam][?][msdocs:Set-VMSwitchTeam]
- VMSwitchTeamMember
[`Add`][Add-VMSwitchTeamMember][?][msdocs:Add-VMSwitchTeamMember]
[`Remove`][Remove-VMSwitchTeamMember][?][msdocs:Remove-VMSwitchTeamMember]
- VMVersion
[`Update`][Update-VMVersion][?][msdocs:Update-VMVersion]
#### iscsi
...
- iSCSITarget
[`Connect`][Connect-IscsiTarget][?][msdocs:Connect-IscsiTarget]
- iSCSITargetPortal
[`New`][New-IscsiTargetPortal][?][msdocs:New-IscsiTargetPortal]
#### iscsitarget
...
- iSCSIServerTarget 
[`Get`][Get-IscsiServerTarget][?][msdocs:Get-IscsiServerTarget]
[**`New`**][New-IscsiServerTarget][?][msdocs:New-IscsiServerTarget]
[`Remove`][Remove-IscsiServerTarget][?][msdocs:Remove-IscsiServerTarget]
[`Set`][Set-IscsiServerTarget][?][msdocs:Set-IscsiServerTarget]
- iSCSIVirtualDisk
[`Checkpoint`][Checkpoint-IscsiVirtualDisk][?][msdocs:Checkpoint-IscsiVirtualDisk]
[`Convert`][Convert-IscsiVirtualDisk][?][msdocs:Convert-IscsiVirtualDisk]
[`Get`][Get-IscsiVirtualDisk][?][msdocs:Get-IscsiVirtualDisk]
[`Import`][Import-IscsiVirtualDisk][?][msdocs:Import-IscsiVirtualDisk]
[**`New`**][New-IscsiVirtualDisk][?][msdocs:New-IscsiVirtualDisk]
[`Remove`][Remove-IscsiVirtualDisk][?][msdocs:Remove-IscsiVirtualDisk]
[`Resize`][Resize-IscsiVirtualDisk][?][msdocs:Resize-IscsiVirtualDisk]
[`Restore`][Restore-IscsiVirtualDisk][?][msdocs:Restore-IscsiVirtualDisk]
[`Set`][Set-IscsiVirtualDisk][?][msdocs:Set-IscsiVirtualDisk]
[`Stop`][Stop-IscsiVirtualDiskOperation][?][msdocs:Stop-IscsiVirtualDiskOperation]
- iSCSIVirtualDiskTargetMapping
[**`Add`**][Add-IscsiVirtualDiskTargetMapping][?][msdocs:Add-IscsiVirtualDiskTargetMapping]
[`Remove`][Remove-IscsiVirtualDiskTargetMapping][?][msdocs:Remove-IscsiVirtualDiskTargetMapping]
...
- Counter [`Get`][Get-Counter][?][msdocs:Get-Counter]
...
- LocalGroupMember
[`Add`][Add-LocalGroupMember][?][msdocs:Add-LocalGroupMember]
[`Get`][Get-LocalGroupMember][?][msdocs:Get-LocalGroupMember]
[`Remove`][Remove-LocalGroupMember][?][msdocs:Remove-LocalGroupMember]
- LocalUser
[`Disable`][Disable-LocalUser][?][msdocs:Disable-LocalUser]
[`Enable`][Enable-LocalUser][?][msdocs:Enable-LocalUser]
[`Get`][Get-LocalUser][?][msdocs:Get-LocalUser]
[`New`][New-LocalUser][?][msdocs:New-LocalUser]
[`Remove`][Remove-LocalUser][?][msdocs:Remove-LocalUser]
[`Rename`][Rename-LocalUser][?][msdocs:Rename-LocalUser]
[`Set`][Set-LocalUser][?][msdocs:Set-LocalUser]
...
- ChildItem
[`Get`][Get-ChildItem][?][msdocs:Get-ChildItem]
- Clipboard
[`Get`][Get-Clipboard][?][msdocs:Get-Clipboard]
[`Set`][Set-Clipboard][?][msdocs:Set-Clipboard]
- Computer
[`Rename`][Rename-Computer][?][msdocs:Rename-Computer]
[`Restart`][Restart-Computer][?][msdocs:Restart-Computer]
[`Stop`][Stop-Computer][?][msdocs:Stop-Computer]
- ComputerInfo
[`Get`][Get-ComputerInfo][?][msdocs:Get-ComputerInfo]
- Connection
[`Test`][Test-Connection][?][msdocs:Test-Connection]
- Content
[`Add`][Add-Content][?][msdocs:Add-Content]
[`Clear`][Clear-Content][?][msdocs:Clear-Content]
[`Get`][Get-Content][?][msdocs:Get-Content]
[`Set`][Set-Content][?][msdocs:Set-Content]
- EventLog
[`Clear`][Clear-EventLog][?][msdocs:Clear-EventLog]
[`Get`][Get-EventLog][?][msdocs:Get-EventLog]
[`Limit`][Limit-EventLog][?][msdocs:Limit-EventLog]
[`New`][New-EventLog][?][msdocs:New-EventLog]
[`Remove`][Remove-EventLog][?][msdocs:Remove-EventLog]
[`Show`][Show-EventLog][?][msdocs:Show-EventLog]
[`Write`][Write-EventLog][?][msdocs:Write-EventLog]
- Item
[`Clear`][Clear-Item][?][msdocs:Clear-Item]
[`Copy`][Copy-Item][?][msdocs:Copy-Item]
[`Get`][Get-Item][?][msdocs:Get-Item]
[`Invoke`][Invoke-Item][?][msdocs:Invoke-Item]
[`Move`][Move-Item][?][msdocs:Move-Item]
[`New`][New-Item][?][msdocs:New-Item]
[`Remove`][Remove-Item][?][msdocs:Remove-Item]
[`Rename`][Rename-Item][?][msdocs:Rename-Item]
[`Set`][Set-Item][?][msdocs:Set-Item]
- ItemProperty
[`Clear`][Clear-ItemProperty][?][msdocs:Clear-ItemProperty]
[`Copy`][Copy-ItemProperty][?][msdocs:Copy-ItemProperty]
[`Get`][Get-ItemProperty][?][msdocs:Get-ItemProperty]
[`Move`][Move-ItemProperty][?][msdocs:Move-ItemProperty]
[`New`][New-ItemProperty][?][msdocs:New-ItemProperty]
[`Remove`][Remove-ItemProperty][?][msdocs:Remove-ItemProperty]
[`Rename`][Rename-ItemProperty][?][msdocs:Rename-ItemProperty]
[`Set`][Set-ItemProperty][?][msdocs:Set-ItemProperty]
- Location
[`Get`][Get-Location][?][msdocs:Get-Location]
[`Pop`][Pop-Location][?][msdocs:Pop-Location]
[`Push`][Push-Location][?][msdocs:Push-Location]
[`Set`][Set-Location][?][msdocs:Set-Location]
- Path
[`Convert`][Convert-Path][?][msdocs:Convert-Path]
[`Join`][Join-Path][?][msdocs:Join-Path]
[`Resolve`][Resolve-Path][?][msdocs:Resolve-Path]
[`Split`][Split-Path][?][msdocs:Split-Path]
[`Test`][Test-Path][?][msdocs:Test-Path]
- Process
[`Get`][Get-Process][?][msdocs:Get-Process]
[`Debug`][Debug-Process][?][msdocs:Debug-Process]
[`Start`][Start-Process][?][msdocs:Start-Process]
[`Stop`][Stop-Process][?][msdocs:Stop-Process]
[`Wait`][Wait-Process][?][msdocs:Wait-Process]
- PSDrive
[`Get`][Get-PSDrive][?][msdocs:Get-PSDrive]
[`New`][New-PSDrive][?][msdocs:New-PSDrive]
[`Remove`][Remove-PSDrive][?][msdocs:Remove-PSDrive]
- RecycleBin
[`Clear`][Clear-RecycleBin][?][msdocs:Clear-RecycleBin]
- Service
[`Get`][Get-Service][?][msdocs:Get-Service]
[`New`][New-Service][?][msdocs:New-Service]
[`Remove`][Remove-Service][?][msdocs:Remove-Service]
[`Restart`][Restart-Service][?][msdocs:Restart-Service]
[`Resume`][Resume-Service][?][msdocs:Resume-Service]
[`Set`][Set-Service][?][msdocs:Set-Service]
[`Start`][Start-Service][?][msdocs:Start-Service]
[`Stop`][Stop-Service][?][msdocs:Stop-Service]
[`Suspend`][Suspend-Service][?][msdocs:Suspend-Service]
- Transaction
[`Complete`][Complete-Transaction][?][msdocs:Complete-Transaction]
[`Start`][Start-Transaction][?][msdocs:Start-Transaction]
- WMIObject
[`Get`][Get-WMIObject][?][msdocs:Get-WMIObject]
...
- Alias
[`Export`][Export-Alias][?][msdocs:Export-Alias]
[`Get`][Get-Alias][?][msdocs:Get-Alias]
[`Import`][Import-Alias][?][msdocs:Import-Alias]
[`New`][New-Alias][?][msdocs:New-Alias]
[`Remove`][Remove-Alias][?][msdocs:Remove-Alias]
[`Set`][Set-Alias][?][msdocs:Set-Alias]
- CliXml
[`Export`][Export-Clixml][?][msdocs:Export-Clixml]
[`Import`][Import-Clixml][?][msdocs:Import-Clixml]
- Date
[`Get`][Get-Date][?][msdocs:Get-Date]
[`Set`][Set-Date][?][msdocs:Set-Date]
- Event 
[`Get`][Get-Event][?][msdocs:Get-Event]
[`New`][New-Event][?][msdocs:New-Event]
[`Remove`][Remove-Event][?][msdocs:Remove-Event]
[`Unregister`][Unregister-Event][?][msdocs:Unregister-Event]
[`Wait`][Wait-Event][?][msdocs:Wait-Event]
- Format-
[`Custom`][Format-Custom][?][msdocs:Format-Custom]
[`Hex`][Format-Hex][?][msdocs:Format-Hex]
[`List`][Format-List][?][msdocs:Format-List]
[`Table`][Format-Table][?][msdocs:Format-Table]
[`Wide`][Format-Wide][?][msdocs:Format-Wide]
- GUID
[`New`][New-Guid][?][msdocs:New-Guid]
- Host
[`Get`][Get-Host][?][msdocs:Get-Host]
[`Read`][Read-Host][?][msdocs:Read-Host]
[`Write`][Write-Host][?][msdocs:Write-Host]
- JSON
[`ConvertFrom`][ConvertFrom-Json][?][msdocs:ConvertFrom-Json]
[`ConvertTo`][ConvertTo-Json][?][msdocs:ConvertTo-Json]
- Markdown
[`ConvertFrom`][ConvertFrom-Markdown][?][msdocs:ConvertFrom-Markdown]
[`Show`][Show-Markdown][?][msdocs:Show-Markdown]
- Random
[`Get`][Get-Random][?][msdocs:Get-Random]
- WebRequest
[`Invoke`][Invoke-WebRequest][?][msdocs:Invoke-WebRequest]
- XML
[`ConvertTo`][ConvertTo-Xml][?][msdocs:ConvertTo-Xml]
[`Select`][Select-Xml][?][msdocs:Select-Xml]
...
- WSManCredSSP
[**`Enable`**][Enable-WSManCredSSP][?][msdocs:Enable-WSManCredSSP]
[`Disable`][Disable-WSManCredSSP][?][msdocs:Disable-WSManCredSSP]
[`Get`][Get-WSManCredSSP][?][msdocs:Get-WSManCredSSP]
...
- NetAdapter 
[`Disable`][Disable-NetAdapter][?][msdocs:Disable-NetAdapter] 
[`Enable`][Enable-NetAdapter][?][msdocs:Enable-NetAdapter]
[`Get`][Get-NetAdapter][?][msdocs:Get-NetAdapter]
- NetAdapterRdma 
[`Enable`][Enable-NetAdapterRdma][?][msdocs:Enable-NetAdapterRdma] 
[`Get`][Get-NetAdapterRdma][?][msdocs:Get-NetAdapterRdma]
- NetAdapterVmq
[`Enable`][Enable-NetAdapterVmq][?][msdocs:Enable-NetAdapterVmq]
[`Get`][Get-NetAdapterVmq][?][msdocs:Get-NetAdapterVmq]
[`Set`][Set-NetAdapterVmq][?][msdocs:Set-NetAdapterVmq]
- NetAdapterVmqQueue
[`Get`][Get-NetAdapterVmqQueue][?][msdocs:Get-NetAdapterVmqQueue]
#### netconnection
...
- NetConnectionProfile [`Get`][Get-NetConnectionProfile][?][msdocs:Get-NetConnectionProfile] [`Set`][Set-NetConnectionProfile][?][msdocs:Set-NetConnectionProfile]
#### netsecurity
...
- NetFirewallRule 
[`Copy`][Copy-NetFirewallRule][?][msdocs:Copy-NetFirewallRule]
[`Disable`][Disable-NetFirewallRule][?][msdocs:Disable-NetFirewallRule]
[**`Enable`**][Enable-NetFirewallRule][?][msdocs:Enable-NetFirewallRule]
[`Get`][Get-NetFirewallRule][?][msdocs:Get-NetFirewallRule]
[`New`][New-NetFirewallRule][?][msdocs:New-NetFirewallRule]
[`Remove`][Remove-NetFirewallRule][?][msdocs:Remove-NetFirewallRule]
[`Rename`][Rename-NetFirewallRule][?][msdocs:Rename-NetFirewallRule]
[`Set`][Set-NetFirewallRule][?][msdocs:Set-NetFirewallRule]
[`Show`][Show-NetFirewallRule][?][msdocs:Show-NetFirewallRule]
- NetFirewallServiceFilter
[`Get`][Get-NetFirewallServiceFilter][?][msdocs:Get-NetFirewallServiceFilter]
[`Set`][Set-NetFirewallServiceFilter][?][msdocs:Set-NetFirewallServiceFilter]
#### nettcpip
...
- NetIPAddress
[`Get`][Get-NetIPAddress][?][msdocs:Get-NetIPAddress]
[`New`][New-NetIPAddress][?][msdocs:New-NetIPAddress]
[`Remove`][Remove-NetIPAddress][?][msdocs:Remove-NetIPAddress]
[`Set`][Set-NetIPAddress][?][msdocs:Set-NetIPAddress]
- NetIPInterface
[`Get`][Get-NetIPInterface][?][msdocs:Get-NetIPInterface]
[`Set`][Set-NetIPInterface][?][msdocs:Set-NetIPInterface]
...
- NanoServerImage
[`Edit`][Edit-NanoServerImage][?][msdocs:Edit-NanoServerImage]
[`New`][New-NanoServerImage][?][msdocs:New-NanoServerImage]
#### netqos
...
- NetQos
[`Get`][Get-NetQosPolicy][?][msdocs:Get-NetQosPolicy]
[`New`][New-NetQosPolicy][?][msdocs:New-NetQosPolicy]
[`Remove`][Remove-NetQosPolicy][?][msdocs:Remove-NetQosPolicy]
[`Set`][Set-NetQosPolicy][?][msdocs:Set-NetQosPolicy]
...
- NLBCluster 
[`Get`][Get-NlbCluster][?][msdocs:Get-NlbCluster]
[**`New`**][New-NlbCluster][?][msdocs:New-NlbCluster]
[`Remove`][Remove-NlbCluster][?][msdocs:Remove-NlbCluster]
[`Resume`][Resume-NlbCluster][?][msdocs:Resume-NlbCluster]
[`Set`][Set-NlbCluster][?][msdocs:Set-NlbCluster]
[`Start`][Start-NlbCluster][?][msdocs:Start-NlbCluster]
[`Stop`][Stop-NlbCluster][?][msdocs:Stop-NlbCluster]
[`Suspend`][Suspend-NlbCluster][?][msdocs:Suspend-NlbCluster]
- NLBClusterPortRule
[`Add`][Add-NlbClusterPortRule][?][msdocs:Add-NlbClusterPortRule]
[`Set`][Set-NlbClusterPortRule][?][msdocs:Set-NlbClusterPortRule]
- NLBClusterVip
[**`Add`**][Add-NlbClusterVip][?][msdocs:Add-NlbClusterVip]
[`Get`][Get-NlbClusterVip][?][msdocs:Get-NlbClusterVip]
[`Remove`][Remove-NlbClusterVip][?][msdocs:Remove-NlbClusterVip]
[`Set`][Set-NlbClusterVip][?][msdocs:Set-NlbClusterVip]
#### nfs
...
- NfsSharePermission
[`Get`][Get-NfsSharePermission][?][msdocs:Get-NfsSharePermission]
[**`Grant`**][Grant-NfsSharePermission][?][msdocs:Grant-NfsSharePermission]
[`Revoke`][Revoke-NfsSharePermission][?][msdocs:Revoke-NfsSharePermission]
#### PackageManagement
...
- Package
[`Find`][Find-Package][?][msdocs:Find-Package]
[`Get`][Get-Package][?][msdocs:Get-Package]
[`Install`][Install-Package][?][msdocs:Install-Package]
[`Save`][Save-Package][?][msdocs:Save-Package]
[`Uninstall`][Uninstall-Package][?][msdocs:Uninstall-Package]
- PackageProvider
[`Find`][Find-PackageProvider][?][msdocs:Find-PackageProvider]
[`Get`][Get-PackageProvider][?][msdocs:Get-PackageProvider]
[`Import`][Import-PackageProvider][?][msdocs:Import-PackageProvider]
[`Install`][Install-PackageProvider][?][msdocs:Install-PackageProvider]
- PackageSource
[`Get`][Get-PackageSource][?][msdocs:Get-PackageSource]
[`Register`][Register-PackageSource][?][msdocs:Register-PackageSource]
[`Set`][Set-PackageSource][?][msdocs:Set-PackageSource]
[`Unregister`][Unregister-PackageSource][?][msdocs:Unregister-PackageSource]
#### pkiclient
...
- Certificate
[`Export`][Export-Certificate][?][msdocs:Export-Certificate]
[`Get`][Get-Certificate][?][msdocs:Get-Certificate]
[`Import`][Import-Certificate][?][msdocs:Import-Certificate]
[`Switch`][Switch-Certificate][?][msdocs:Switch-Certificate]
[`Test`][Test-Certificate][?][msdocs:Test-Certificate]
- CertificateAutoEnrollmentPolicy
[`Get`][Get-CertificateAutoEnrollmentPolicy][?][msdocs:Get-CertificateAutoEnrollmentPolicy]
[`Set`][Set-CertificateAutoEnrollmentPolicy][?][msdocs:Set-CertificateAutoEnrollmentPolicy]
- CertificateEnrollmentPolicyServer
[`Add`][Add-CertificateEnrollmentPolicyServer][?][msdocs:Add-CertificateEnrollmentPolicyServer]
[`Get`][Get-CertificateEnrollmentPolicyServer][?][msdocs:Get-CertificateEnrollmentPolicyServer]
[`Remove`][Remove-CertificateEnrollmentPolicyServer][?][msdocs:Remove-CertificateEnrollmentPolicyServer]
- CertificateNotificationTask
[`Get`][Get-CertificateNotificationTask][?][msdocs:Get-CertificateNotificationTask]
[`New`][New-CertificateNotificationTask][?][msdocs:New-CertificateNotificationTask]
[`Remove`][Remove-CertificateNotificationTask][?][msdocs:Remove-CertificateNotificationTask]
- PfxCertificate
[`Export`][Export-PfxCertificate][?][msdocs:Export-PfxCertificate]
[`Import`][Import-PfxCertificate][?][msdocs:Import-PfxCertificate]
- PfxData
[`Get`][Get-PfxData][?][msdocs:Get-PfxData]
- SelfSignedCertificate
[`New`][New-SelfSignedCertificate][?][msdocs:New-SelfSignedCertificate]
...
- DSCConfiguration
[`Get`][Get-DscConfiguration][?][msdocs:Get-DscConfiguration]
[`Publish`][Publish-DscConfiguration][?][msdocs:Publish-DscConfiguration]
[`Restore`][Restore-DscConfiguration][?][msdocs:Restore-DscConfiguration]
[`Start`][Start-DscConfiguration][?][msdocs:Start-DscConfiguration]
[`Stop`][Stop-DscConfiguration][?][msdocs:Stop-DscConfiguration]
[`Test`][Test-DscConfiguration][?][msdocs:Test-DscConfiguration]
[`Update`][Update-DscConfiguration][?][msdocs:Update-DscConfiguration]
[`Remove`][Remove-DscConfigurationDocument][?][msdocs:Remove-DscConfigurationDocument]
#### scheduledtasks
...
- ScheduledTask
[`Disable`][Disable-ScheduledTask][?][msdocs:Disable-ScheduledTask]
[`Enable`][Enable-ScheduledTask][?][msdocs:Enable-ScheduledTask]
[`Export`][Export-ScheduledTask][?][msdocs:Export-ScheduledTask]
[`Get`][Get-ScheduledTask][?][msdocs:Get-ScheduledTask]
[`New`][New-ScheduledTask][?][msdocs:New-ScheduledTask]
[**`Register`**][Register-ScheduledTask][?][msdocs:Register-ScheduledTask]
[`Set`][Set-ScheduledTask][?][msdocs:Set-ScheduledTask]
[`Start`][Start-ScheduledTask][?][msdocs:Start-ScheduledTask]
[`Stop`][Stop-ScheduledTask][?][msdocs:Stop-ScheduledTask]
[`Unregister`][Unregister-ScheduledTask][?][msdocs:Unregister-ScheduledTask]
- ScheduledTaskAction
[**`New`**][New-ScheduledTaskAction][?][msdocs:New-ScheduledTaskAction]
- ScheduledTaskTrigger
[**`New`**][New-ScheduledTaskTrigger][?][msdocs:New-ScheduledTaskTrigger]
...
- WindowsFeature
[`Get`][Get-WindowsFeature][?][msdocs:Get-WindowsFeature]
[`Install`][Install-WindowsFeature][?][msdocs:Install-WindowsFeature]
[`Uninstall`][Uninstall-WindowsFeature][?][msdocs:Uninstall-WindowsFeature]
#### servermigration
...
- SmigServerData 
[`Receive`][Receive-SmigServerData][?][msdocs:Receive-SmigServerData] 
[`Send`][Send-SmigServerData][?][msdocs:Send-SmigServerData]
- SmigServerFeature 
[`Get`][Get-SmigServerFeature][?][msdocs:Get-SmigServerFeature]
- SmigServerSetting 
[`Export`][Export-SmigServerSetting][?][msdocs:Export-SmigServerSetting] 
[`Import`][Import-SmigServerSetting][?][msdocs:Import-SmigServerSetting]
#### smbshare
...
- SmbPathAcl
[**`Set`**][Set-SmbPathAcl][?][msdocs:Set-SmbPathAcl]
- SmbShare
[`Get`][Get-SmbShare][?][msdocs:Get-SmbShare]
[**`New`**][New-SmbShare][?][msdocs:New-SmbShare]
[`Remove`][Remove-SmbShare][?][msdocs:Remove-SmbShare]
[`Set`][Set-SmbShare][?][msdocs:Set-SmbShare]
- SmbShareAccess
[`Block`][Block-SmbShareAccess][?][msdocs:Block-SmbShareAccess]
[**`Get`**][Get-SmbShareAccess][?][msdocs:Get-SmbShareAccess]
[`Grant`][Grant-SmbShareAccess][?][msdocs:Grant-SmbShareAccess]
[`Revoke`][Revoke-SmbShareAccess][?][msdocs:Revoke-SmbShareAccess]
[`Unblock`][Unblock-SmbShareAccess][?][msdocs:Unblock-SmbShareAccess]</sup
#### storage
...
- Disk
[`Clear`][Clear-Disk][?][msdocs:Clear-Disk]
[`Get`][Get-Disk][?][msdocs:Get-Disk]
[`Initialize`][Initialize-Disk][?][msdocs:Initialize-Disk]
[`Set`][Set-Disk][?][msdocs:Set-Disk]
[`Update`][Update-Disk][?][msdocs:Update-Disk]
- FileShare
[`Debug`][Debug-FileShare][?][msdocs:Debug-FileShare]
[`Get`][Get-FileShare][?][msdocs:Get-FileShare]
[`New`][New-FileShare][?][msdocs:New-FileShare]
[`Remove`][Remove-FileShare][?][msdocs:Remove-FileShare]
[`Set`][Set-FileShare][?][msdocs:Set-FileShare]
- Partition
[`Get`][Get-Partition][?][msdocs:Get-Partition]
[`New`][New-Partition][?][msdocs:New-Partition]
[`Remove`][Remove-Partition][?][msdocs:Remove-Partition]
[`Resize`][Resize-Partition][?][msdocs:Resize-Partition]
[`Set`][Set-Partition][?][msdocs:Set-Partition]
- PhysicalDisk
[`Add`][Add-PhysicalDisk][?][msdocs:Add-PhysicalDisk]
[`Get`][Get-PhysicalDisk][?][msdocs:Get-PhysicalDisk]
[`Remove`][Remove-PhysicalDisk][?][msdocs:Remove-PhysicalDisk]
[`Reset`][Reset-PhysicalDisk][?][msdocs:Reset-PhysicalDisk]
[`Set`][Set-PhysicalDisk][?][msdocs:Set-PhysicalDisk]
- StoragePool
[`Get`][Get-StoragePool][?][msdocs:Get-StoragePool]
[**`New`**][New-StoragePool][?][msdocs:New-StoragePool]
[`Optimize`][Optimize-StoragePool][?][msdocs:Optimize-StoragePool]
[`Remove`][Remove-StoragePool][?][msdocs:Remove-StoragePool]
[`Set`][Set-StoragePool][?][msdocs:Set-StoragePool]
[`Update`][Update-StoragePool][?][msdocs:Update-StoragePool]
- StorageTier
[`Get`][Get-StorageTier][?][msdocs:Get-StorageTier]
[**`New`**][New-StorageTier][?][msdocs:New-StorageTier]
[`Remove`][Remove-StorageTier][?][msdocs:Remove-StorageTier]
[`Resize`][Resize-StorageTier][?][msdocs:Resize-StorageTier]
[`Set`][Set-StorageTier][?][msdocs:Set-StorageTier]
- Volume
[`Debug`][Debug-Volume][?][msdocs:Debug-Volume]
[`Format`][Format-Volume][?][msdocs:Format-Volume]
[`Get`][Get-Volume][?][msdocs:Get-Volume]
[`New`][New-Volume][?][msdocs:New-Volume]
[`Optimize`][Optimize-Volume][?][msdocs:Optimize-Volume]
[`Repair`][Repair-Volume][?][msdocs:Repair-Volume]
[`Set`][Set-Volume][?][msdocs:Set-Volume]
#### storagereplica
...
- WsusClassification
[`Get`][Get-WsusClassification][?][msdocs:Get-WsusClassification]
[`Set`][Set-WsusClassification][?][msdocs:Set-WsusClassification]
- WsusComputer
[`Add`][Add-WsusComputer][?][msdocs:Add-WsusComputer]
[`Get`][Get-WsusComputer][?][msdocs:Get-WsusComputer]
- WsusDynamicCategory
[`Add`][Add-WsusDynamicCategory][?][msdocs:Add-WsusDynamicCategory]
[`Get`][Get-WsusDynamicCategory][?][msdocs:Get-WsusDynamicCategory]
[`Remove`][Remove-WsusDynamicCategory][?][msdocs:Remove-WsusDynamicCategory]
[`Set`][Set-WsusDynamicCategory][?][msdocs:Set-WsusDynamicCategory]
- WsusProduct
[`Get`][Get-WsusProduct][?][msdocs:Get-WsusProduct]
[`Set`][Set-WsusProduct][?][msdocs:Set-WsusProduct]
- WsusServer
[`Get`][Get-WsusServer][?][msdocs:Get-WsusServer]
- WsusServerCleanup
[`Invoke`][Invoke-WsusServerCleanup][?][msdocs:Invoke-WsusServerCleanup]
- WsusServerSynchronization
[`Set`][Set-WsusServerSynchronization][?][msdocs:Set-WsusServerSynchronization]
- WsusUpdate
[`Approve`][Approve-WsusUpdate][?][msdocs:Approve-WsusUpdate]
[`Deny`][Deny-WsusUpdate][?][msdocs:Deny-WsusUpdate]
[`Get`][Get-WsusUpdate][?][msdocs:Get-WsusUpdate]
...
- SCVirtualMachine [`Set`][Set-SCVirtualMachine][?][msdocs:Set-SCVirtualMachine]
#### wds
...
- WDSBootImage
[`Disable`][Disable-WdsBootImage][?][msdocs:Disable-WdsBootImage]
[`Enable`][Enable-WdsBootImage][?][msdocs:Enable-WdsBootImage]
[`Export`][Export-WdsBootImage][?][msdocs:Export-WdsBootImage]
[`Get`][Get-WdsBootImage][?][msdocs:Get-WdsBootImage]
[**`Import`**][Import-WdsBootImage][?][msdocs:Import-WdsBootImage]
[`Remove`][Remove-WdsBootImage][?][msdocs:Remove-WdsBootImage]
[`Set`][Set-WdsBootImage][?][msdocs:Set-WdsBootImage]
- WDSInstallImage
[`Copy`][Copy-WdsInstallImage][?][msdocs:Copy-WdsInstallImage]
[`Disable`][Disable-WdsInstallImage][?][msdocs:Disable-WdsInstallImage]
[`Enable`][Enable-WdsInstallImage][?][msdocs:Enable-WdsInstallImage]
[`Export`][Export-WdsInstallImage][?][msdocs:Export-WdsInstallImage]
[`Get`][Get-WdsInstallImage][?][msdocs:Get-WdsInstallImage]
[`Import`][Import-WdsInstallImage][?][msdocs:Import-WdsInstallImage]
[`Remove`][Remove-WdsInstallImage][?][msdocs:Remove-WdsInstallImage]
[`Set`][Set-WdsInstallImage][?][msdocs:Set-WdsInstallImage]
- WDSInstallImageGroup
[`Get`][Get-WdsInstallImageGroup][?][msdocs:Get-WdsInstallImageGroup]
[**`New`**][New-WdsInstallImageGroup][?][msdocs:New-WdsInstallImageGroup]
[`Remove`][Remove-WdsInstallImageGroup][?][msdocs:Remove-WdsInstallImageGroup]
[`Set`][Set-WdsInstallImageGroup][?][msdocs:Set-WdsInstallImageGroup]
#### windowsserverbackup
...
- WBPolicy
[`Get`][Get-WBPolicy][?][msdocs:Get-WBPolicy]
[`New`][New-WBPolicy][?][msdocs:New-WBPolicy]
[`Remove`][Remove-WBPolicy][?][msdocs:Remove-WBPolicy]
[`Set`][Set-WBPolicy][?][msdocs:Set-WBPolicy]
- WBVirtualMachine
[`Add`][Add-WBVirtualMachine][?][msdocs:Add-WBVirtualMachine]
[`Get`][Get-WBVirtualMachine][?][msdocs:Get-WBVirtualMachine]
[`Remove`][Remove-WBVirtualMachine][?][msdocs:Remove-WBVirtualMachine]
- WBVolume
[`Add`][Add-WBVolume][?][msdocs:Add-WBVolume]
[`Get`][Get-WBVolume][?][msdocs:Get-WBVolume]
[`Remove`][Remove-WBVolume][?][msdocs:Remove-WBVolume]
## Syntax
### Control flow
```powershell
if ($condition) {
...
### Variables
### [Automatic variables][msdocs:Automatic variables]
...
### [Environment variables][msdocs:Environment variables]
...
```
### [Unlock-ADAccount][msdocs:Unlock-ADAccount]
Unlock account
```powershell
Unlock-ADAccount -identity wbryan
```
### [Set-ADAccountPassword][msdocs:Set-ADAccountPassword]
...
```
### [Add-ADGroupMember][msdocs:Add-ADGroupMember]
[Add a member to a group](#add-a-member-to-a-group)
### [Get-ADObject][msdocs:Get-ADObject]
Display version of Active Directory schema [nolabnoparty.com](https://nolabnoparty.com/en/finding-active-directory-schema-version/ "Finding the Active Directory schema version")
```powershell
Get-ADObject "cn=schema,cn=configuration,dc=domain,dc=com" -properties objectversion
```
### [Set-ADObject][msdocs:Set-ADObject]
...
```
### [Install-ADDSForest][msdocs:Install-ADDSForest]
Add a new forest
```powershell
...
### [Install-ADDSDomain][msdocs:Install-ADDSDomain]
Add a new domain
...
```
### [Uninstall-ADDSDomainController][msdocs:Uninstall-ADDSDomainController]
...
```
### [New-ADComputer][msdocs:New-ADComputer]
### [Add-ADPrincipalGroupMembership][msdocs:Add-ADPrincipalGroupMembership]
```powershell
...
```
### [Get-ADForest][msdocs:Get-ADForest]
Display installed forests
```powershell
Get-ADForest | select -ExpandProperty domains
```
### [Get-ADPrincipalGroupMembership][msdocs:Get-ADPrincipalGroupMembership]
[Jones][Jones]
...
```
### [Add-DistributionGroupMember][msdocs:Add-DistributionGroupMember]
...
### [Add-DnsServerPrimaryZone][msdocs:Add-DnsServerPrimaryZone]
**`Name`**
**`ReplicationScope`**
```powershell
...
```
### [Export-Alias][msdocs:Export-Alias]
Export session aliases to a ".ps1" file
```powershell
Export-Alias -Path alias.ps1 -As Script
```
### [Get-Alias][msdocs:Get-Alias]
Display aliases
```powershell
Get-Alias
```
...
```
### [New-Alias][msdocs:New-Alias]
Establish a new alias
```powershell
New-Alias ip Get-NetIPAddress
```
### [Set-Alias][msdocs:Set-Alias]
Edit an existing alias
```powershell
Set-Alias ip Get-NetAdapter
```
### [Get-Clipboard][msdocs:Get-Clipboard]
...
```
### [Set-Clipboard][msdocs:Set-Clipboard]
...
```
### [Add-Computer][msdocs:Add-Computer]
...
### [Rename-Computer][msdocs:Rename-Computer]
`NewName`
```powershell
Rename-Computer -NewName $newname -Force -Restart
```
### [Restart-Computer][msdocs:Restart-Computer]
Restart computer
### [Get-ChildItem][msdocs:Get-ChildItem]
### [Get-Command][msdocs:Get-Command]
Display source code of a function [docs.microsoft.com](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_functions "About Functions"
```powershell
(Get-Command mkdir).Definition
```
### [Invoke-Command][msdocs:Invoke-Command]
...
```
### [Get-ComputerInfo][msdocs:Get-ComputerInfo]
Display computer name [cmd](README.md#hostname)
```powershell
Get-ComputerInfo -Property CsName
gin.CsName
```
### [Get-Help][msdocs:Get-Help]
...
### [Update-Help][msdocs:Update-Help]
Download help files
### [Write-Host][msdocs:Write-Host]
`BackgroundColor`
`ForegroundColor`

Exclusively used for drawing text on the screen.
### [Import-GPO][msdocs:Import-GPO]
Import a GPO from backup
```powershell
Import-GPO -BackupGpoName "IT Managers" -TargetName "Sales Managers" -Path \\LON-DC1\Backup
```
### [Import-Module][msdocs:Import-Module]
Import `SmbShare` module
```powershell
Import-Module SmbShare
```
### [Install-Module][msdocs:Install-Module]
Install the `Az` module
```powershell
Install-Module -Name Az -AllowClobber
```
### [Write-Output][msdocs:Write-Output]
Copy text to clipboard
```powershell
Write-Output 'Hello' | Set-Clipboard
```
Create a text file [Jones][Jones]
```powershell
Write-Output "This is a test network file." -Path | Out-File C:\networkfiles\test.txt
```
### [New-PSDrive][msdocs:New-PSDrive]
Start a new PSDrive using the `HKEY_CLASSES_ROOT` Windows Registry hive [powershelleverydayfaq.blogspot.com](http://powershelleverydayfaq.blogspot.com/2012/06/how-to-query-hkeyclassesroot.html "How to query HKEY_CLASSES_ROOT")
```powershell
ndr -Name HKCR -PSProvider Registry -Root HKEY_CLASSES_ROOT
```
### [Get-PSReadlineOption][msdocs:Get-PSReadlineOption]
...
```
### [Set-PSReadlineOption][msdocs:Set-PSReadlineOption]
...
```
### [Add-PSSnapin][msdocs:Add-PSSnapin]
### [Format-Table][msdocs:Format-Table]
`HideTableHeaders`
...
```
### [Add-Type][msdocs:Add-Type]
Generate a random password 20 characters long [adamtheautomator.com][https://adamtheautomator.com/powershell-random-password/]
```powershell
Add-Type -AssemblyName 'System.Web'
[System.Web.Security.Membership]::GeneratePassword(20, 3)
```
### [Get-NetConnectionProfile][msdocs:Get-NetConnectionProfile]
```powershell
$NetworkProfile = Get-NetConnectionProfile -InterfaceAlias "Ethernet"
$NetworkProfile.NetworkCategory = "Public"
```
### [Set-NetConnectionProfile][msdocs:Set-NetConnectionProfile]
```powershell
Set-NetConnectionOject -InputObject $NetworkProfile
```
### [Add-DhcpServerv4Scope][msdocs:Add-DhcpServerv4Scope]
[Jones][Jones]

```powershell
Add-DhcpServerv4Scope -Name "PacktLabNet" -StartRange 10.0.0.50 -EndRange 10.0.0.100 -SubnetMask 255.255.255.0
```
### [Add-DhcpServerInDC][msdocs:Add-DhcpServerInDC]
[Jones][Jones]
...
```
### [Set-DhcpServerv4OptionValue][msdocs:Set-DhcpServerv4OptionValue]
[Jones][Jones]

```powershell
Set-DhcpServerv4OptionValue -DnsDomain corp.packtlab.com -DnsServer 10.0.0.1
```
### [Set-DnsClientServerAddress][msdocs:Set-DnsClientServerAddress]
**`InterfaceAlias`**
`InterfaceIndex`
`ResetServerAddresses`
`ServerAddresses`

Configure DNS server address for a DC on a new corporate intranet [Jones][Jones]
```powershell
Set-DnsClientServerAddress -InterfaceAlias "Ethernet" -ServerAddresses 127.0.0.1
```
Configure DNS server addresses for a network interface while setting up Server Core[Zacker][Zacker]: 20
```powershell
Set-DnsClientServerAddress -InterfaceIndex 6 -ServerAddresses ("192.168.0.1", "192.168.0.2")
```
Set an interface to get its DNS server from DHCP [docs.microsoft.com](https://docs.microsoft.com/en-us/powershell/module/dnsclient/set-dnsclientserveraddress "Set-DnsClientServerAddress")
```powershell
Set-DnsClientServerAddress -InterfaceIndex 12 -ResetServerAddresses
```
### [Resolve-DnsName][msdocs:Resolve-DnsName]
```powershell
Resolve-DNSName -Name secure.practicelabs.com.trustanchors -Type dnskey -Server plabdm01
```
### [Get-NetAdapter][msdocs:Get-NetAdapter]
Display available network interfaces [Zacker][Zacker]: 19
### [Enable-NetFirewallRule][msdocs:Enable-NetFirewallRule]
**`Name`**

Configure the firewall to allow Hyper-V replication [Zacker][Zacker]: 301
```powershell
...
```
### [Get-NetFirewallRule][msdocs:Get-NetFirewallRule]
...
```
### [New-NetFirewallRule][msdocs:New-NetFirewallRule]
...
```
### [Set-NetFirewallRule][msdocs:Set-NetFirewallRule]
...
```
### [New-NetIpAddress][msdocs:New-NetIpAddress]
...
Configure the Domain Controller in a new corporate intranet [Jones][Jones]
```powershell
...
```
### [New-NLBCluster][msdocs:New-NlbCluster]
Configure a multi-homed server as a node in multiple NLB clusters, with each network adapter added to a different cluster. [Practice Test][mu:70-740]
```powershell
New-NlbCluster
```
### [Set-NetIpInterface][msdocs:Set-NetIpInterface]
Enable DHCP [4sysops.com](https://4sysops.com/archives/set-an-ip-address-and-configure-dhcp-with-powershell/ "Set an IP address and configure DHCP with Powershell")
```powershell
Set-NetIPInterface -InterfaceAlias 'Ethernet 2' -Dhcp Enabled
```
### [Invoke-WebRequest][msdocs:Invoke-WebRequest]
...
```
### [Install-Package][msdocs:Install-Package]
Download and install **Docker Engine - Enterprise** (not supported on Windows 10 clients) [Zacker][Zacker]: 266
```powershell
Install-Package docker -ProviderName dockermsftprovider
```

### [Install-PackageProvider][msdocs:Install-PackageProvider]
Install [NuGet][NuGet]
```powershell
Install-PackageProvider -Name NuGet
```
Since April 3, 2020 the minimum TLS version was raised on the provider lookup site. [stackoverflow.com](https://stackoverflow.com/questions/16657778/install-nuget-via-powershell-script/26421187 "Install NuGet via Powershell script")
```powershell
[System.Net.ServicePointManager]::SecurityProtocol=[System.Net.SecurityProtocolType]'Tls11,Tls12'
```
### [Optimize-VHD][msdocs:Optimize-VHD]
Compact a VHD [Zacker][Zacker]: 228
```powershell
Optimize-VHD -Path $FILE -Mode full
```
### [Register-ScheduledTask][msdocs:Register-ScheduledTask]
```powershell
...
```
### [Register-PackageSource][msdocs:Register-PackageSource]
```powershell
Register-PackageSource -Name NuGet -Location https://www.nuget.org/api/v2 -ProviderName NuGet -Trusted
```
### [Start-Process][msdocs:Start-Process]
Run a program as admin
```powershell
Start-Process cmd -Verb runas
saps cmd -v runas
```
### [Enable-PSRemoting][msdocs:Enable-PSRemoting]
...
### [Dismount-VHD][msdocs:Dismount-VHD]
Zacker: 225
```powershell
...
Create a **Storage Spaces Direct** virtual disk that uses parity resiliency and two tiers, with the default friendly names of Performance for SSDs and Capacity for HDDs [Zacker][Zacker]: 355
```powershell
...
```
Create a VHD with a Mirror layout [Practice Lab][pl:70-740]
```powershell
...
```
### [New-Website][msdocs:New-Website]
...
Create a new partition mounted to F: using the ReFS filesystem [Practice Lab][pl:70-740]
```powershell
New-Partition -DiskNumber 3 -UseMaximumSize -DriveLetter F | Format-Volume -NewFileSystemLabel “PLABS-Test” -FileSystem ReFS
```
### [Enable-DedupVolume][msdocs:Enable-DedupVolume]
...
Enable deduplication [Zacker][Zacker]: 157
```powershell
...
Reverse the direction of storage replica, in a case where the source goes down [MeasureUp][mu:70-740]
```powershell
...
```
### [Expand-Archive][msdocs:Expand-Archive]
Decompress archives
```powershell
Expand-Archive
```
### [Export-CliXml][msdocs:Export-CliXml]
### [Import-CliXml][msdocs:Import-CliXml]
### [Add-Content][msdocs:Add-Content]
...
```
### [Get-Content][msdocs:Get-Content]
Make a PowerShell object from a JSON file
```powershell
Get-Content -Path file.json | ConvertFrom-Json
```
### [Export-Csv][msdocs:Export-Csv]
### [Import-Csv][msdocs:Import-Csv]
...
```
### [Convert-VHD][msdocs:Convert-VHD]
...
Convert a fixed VHD to a dynamic VHDX [Zacker][Zacker]: 228, [MeasureUp][mu:70-740]
```powershell
...
```
### [Copy-GPO][msdocs:Copy-GPO]
Copy a GPO [Warren: 170][Warren]
```powershell
Copy-GPO -SourceName "IT Managers" -TargetName "Sales Managers"
```
### [Copy-Item][msdocs:Copy-Item]
Copy files to and from an open Powershell session [Zacker][Zacker]: 180
```powershell
...
```
### [Get-Item][msdocs:Get-Item]
Equivalents to bash `basename` and `dirname` [stackoverflow](https://stackoverflow.com/questions/12503871/removing-path-and-extension-from-filename-in-powershell "Removing path and extension from filename in powershell")
```powershell
...
```
### [Remove-Item][msdocs:Remove-Item]
...
```
Clear Teams cache [commsverse.blog](https://commsverse.blog/2018/09/28/clear-the-microsoft-teams-client-cache/ "Clear the Microsoft Teams client cache")
```powershell
...
```
### [Set-Item][msdocs:Set-Item]
Add an IP address to the Trusted Hosts list, bypassing the use of Kerberos to authenticate the session [Zacker][Zacker]: 56
```powershell
Set-Item wsman:\localhost\client\trustedhosts "192.168.10.41"
```
Enable CredSSP on the local computer [Jones][SOPR]: 50
```powershell
Set-Item WSMAN:\localhost\client\auth\credssp -value $true
```
Enable CredSSP on the intermediate server when attempting to make the "second hop" [Jones][SOPR]: 50
```powershell
Set-Item WSMAN:\localhost\service\auth\credssp -value $true
```
### [New-ItemProperty][msdocs:New-ItemProperty]
Create a Registry key in order to use a local user account that is not the builtin Administrator account in order to manage a single domain cluster [Zacker][Zacker]: 315
```powershell
...
Create a custom property [Pfeiffer](https://portal.cloudskills.io/products/azure-powershell-the-ultimate-beginners-course/categories/2529580/posts/8443858 "Azure PowerShell course") 
```powershell
...
### [Mount-VHD][msdocs:Mount-VHD]
Mount a VHD or VHDX file [Zacker][Zacker]: 92, 225
```powershell
Mount-VHD -Path $file
```
### [New-VHD][msdocs:New-VHD]
...
```
Differencing disk [Practice Lab][pl:70-740]
```powershell
...
Import a VM into the Hyper-V host [Zacker][Zacker]: 373
```powershell
...
Perform a live migraiton [Zacker][Zacker]: 307
```powershell
...
Create a Nano Server VM from an image file [Zacker][Zacker]: 47
```powershell
...
Disable dynamic memory [MeasureUp][mu:70-740]
```powershell
Set-VM -StaticMemory
```
### [Grant-NfsSharePermission][msdocs:Grant-NfsSharePermission]
...
### [Set-VMDvdDrive][msdocs:Set-VMDvdDrive]
**`VMName`**
**`ControllerNumber`**
**`ControllerLocation`**
**`Path`**
...
```
### [Set-VMHardDiskDrive][msdocs:Set-VMHardDiskDrive]
**`VMName`**
**`ControllerType`**
**`ControllerNumber`**
**`ControllerLocation`**
...
```
Select Secure Boot template in order to load supported Linux distributions [IMWS][IMWS]; [Zacker][Zacker]: 208
```powershell
Set-VMFirmware $vm -SecureBootTemplate MicrosoftUEFICertificateAuthority
```
### [Set-VMHost][msdocs:Set-VMHost]
...
```
### [Set-VMMemory][msdocs:Set-VMMemory]
`DynamicMemory`
### [Set-VMMigrationNetwork][msdocs:Set-VMMigrationNetwork]
Tasks:
...
```
### [Set-VMProcessor][msdocs:Set-VMProcessor]
`ExposeVirtualizationExtensions`
### [Set-VMReplication][msdocs:Set-VMReplication]
**`VMName`**
**`ReplicaServerName`**
**`ReplicaServerPort`**
**`AuthenticationType`**
### [Set-VMReplicationServer][msdocs:Set-VMReplicationServer]
**`ReplicationEnabled`**
**`AllowedAuthenticationType`**
**`ReplicationAllowedFromAnyServer`**

Configure a server's replica configuration [Zacker][Zacker]: 300
```powershell
...
Virtual switches can be [external][external virtual switch], [internal][internal virtual switch], or [private][private virtual switch] (in order of decreasing access). [Zacker][Zacker]: 241
...
Create a new virtual switch [Zacker][Zacker]: 242
```powershell
...
### [Add-VMHardDiskDrive][msdocs:Add-VMHardDiskDrive]
...
Create a network adapter [Zacker][Zacker]: 237
```powershell
...
Remove a network adapter [Zacker][Zacker]: 237
```powershell
...
Set bandwidth limits on a virtual network adapter [Zacker][Zacker]: 256
```powershell
Set-VMNetworkAdapter -VMName server1 -Name nic1 -MinimumBandwidthWeight
```
### [New-EventLog][msdocs:New-EventLog]
`LogName`
`Source`
...
```
### [Write-EventLog][msdocs:Write-EventLog]
...
```
### [New-GPLink][msdocs:New-GPLink]
Link a GPO to an OU [Warren: 164][Warren]
```powershell
New-GPLink -Name "IT MAnagers" -Target "ou=IT, dc=Adatum,dc=com"
```
### [New-GPO][msdocs:New-GPO]
Create a GPO and link it [Warren: 164][Warren]
```powershell
New-GPO -Name "IT Managers" | New-GPLink -Target "ou=IT,dc=Adatum,dc=com" -LinkEnabled Yes
```
### [New-Guid][msdocs:New-Guid]
Generate a GUID
```powershell
New-Guid
(New-Guid).Guid | clip
...
### [Edit-NanoServerImage][msdocs:Edit-NanoServerImage]
...
Add the Web Server (IIS) role to an image file. [Zacker][Zacker]: 49
```powershell
...
Create a new Nano Server image with a static IP [Zacker][Zacker]: 52
```powershell
...
```
Container host [Zacker][Zacker]: 264
```powershell
...
```
### [Get-Service][msdocs:Get-Service]
Display status of &lt;WinRM&gt; service
```powershell
Get-Service WinRM
gsv winrm
```
### [Set-Service][msdocs:Set-Service]
```powershell
Set-Service WtcOtg -StartupType Disabled
```
### [Set-SmbPathAcl][msdocs:Set-SmbPathAcl]
Configure a shared folder's NTFS permissions to match the SMB share access permissions [MeasureUp][mu:70-740]
```powershell
Set-SmbPathAcl -ShareName "Share1"
```
### [Start-Service][msdocs:Start-Service]
Start the `WinRM` service
```powershell
sasv winrm
```
### [Start-VMInitialReplication][msdocs:Start-VMInitialReplication]
**`VMName`**

### [Stop-Service][msdocs:Stop-Service]
Stop the WebTitan service
```powershell
Stop-Service WtcOtg
```
### [Get-WmiObject][msdocs:Get-WmiObject]
View system uptime
```powershell
...
```
Display Windows activation key [thewindowsclub.com][https://www.thewindowsclub.com/find-windows-product-key]
```powershell
...
```
Display all objects of type `Win32_LogicalDisk` [YouTube](https://youtu.be/Qy0c_9peoac "Windows PowerShell Fundamentals Chapter 07 - WMI and PowerShell") [cmd](README.md '```&#10;C:\>wmic logicaldisk list brief&#10;```')
```powershell
Get-WmiObject -Query "SELECT * FROM Win32_LogicalDisk"
gwmi -q "select * from win32_logicaldisk"
```
### [Get-WindowsFeature][msdocs:Get-WindowsFeature]
...
Get-WindowsFeature
```
### [Install-WindowsFeature][msdocs:Install-WindowsFeature]
...
Install Hyper-V Powershell module [Zacker][Zacker]: 90
```powershell
...
```
Install Web Server [Jones][Jones]
```powershell
...
```
Create a DHCP server [Jones][Jones]
```powershell
Install-WindowsFeature DHCP -IncludeManagementTools
```
Install Windows Server Migration Tools [Zacker][Zacker]: 33
```powershell
Install-WindowsFeature Migration
```
Install WSUS [Zacker][Zacker]: 393
```powershell
...
```
Install a Windows role or feature to an offline virtual disk Zacker: 225
```powershell
Install-WindowsFeature -VHD $FILE -Name web-server -IncludeManagementTools
```
### [Start-DedupJob][msdocs:Start-DedupJob]
`Memory`
`Type`
...
Used to erect a **push architecture** in [DSC](dsc.md). [Zacker][Zacker]: 27
### [Set-NetQosDcbxSetting][msdocs:Set-NetQosDcbxSetting]
Set the DCBX Willing bit to false, enabling the CNA to receive only local configuration settings, namely those created with subsequent `DcbQos` cmdlets [Zacker][Zacker]: 143
```powershell
Set-NetQosDcbxSetting -Willing 0
```
### [New-SRPartnership][msdocs:New-SRPartnership]
Establish the actual replication partnership between the source and the destination servers [Zacker][Zacker]: 154
```powershell
...
```
### [Test-VMReplicationConnection][msdocs:Test-VMReplicationConnection]
```powershell
...
### [Enable-VMMigration][msdocs:Enable-VMMigration]

### [Enable-VMReplication][msdocs:Enable-VMReplication]
**`VMName`**
**`ReplicaServerName`**
**`ReplicaServerPort`**
**`AuthenticationType`**
...
```
### [Enable-VMResourceMetering][msdocs:Enable-VMResourceMetering]
**`VMName`**
### [Enable-WindowsOptionalFeature][msdocs:Enable-WindowsOptionalFeature]
`FeatureName`
`Online`

Enable a feature in the currently running operating system [docs.microsoft.com](https://docs.microsoft.com/en-us/powershell/module/dism/enable-windowsoptionalfeature?view=win10-ps&redirectedfrom=MSDN "Microsoft Docs: \"Enable-WindowsOptionalFeature\"")
```powershell
Enable-WindowsOptionalFeature -Online -FeatureName "Hearts" -All
```
Install WSL [Reddit](https://www.reddit.com/r/bashonubuntuonwindows/comments/7smf9m/help_wsl_wont_activate_on_my_freshly_installed/ "Reddit: \"[help] WSL won't activate on my freshly installed Windows 10 version 1709\"")
```powershell
...
Create a cluster which will be assigned a dynamic address [Zacker][Zacker]: 313
```powershell
New-Cluster -Name cluster1 -Node server1,server2
```
Create a cluster which will be assigned a static address [Zacker][Zacker]: 313
```powershell
New-Cluster -Name cluster1 -Node server1,server2 -StaticAddress 10.0.0.3
```
Multiple static addresses [msdocs](https://docs.microsoft.com/en-us/previous-versions/windows/it-pro/windows-server-2012-r2-and-2012/mt271006(v=ws.11) "Step 2: Create the Scale-Out File Server and storage pools")
```powershell
New-Cluster -Name FileServerCluster01 -Node FSNode01,FSNode02 -StaticAddress 10.10.1.60,10.10.2.60
```
Create an Active Directory-detached cluster [Zacker][Zacker]: 337
```powershell
...
Pause a node and move ("drain") its workloads with `-Drain`. [docs.microsoft.com](https://docs.microsoft.com/en-us/powershell/module/failoverclusters/suspend-clusternode "Suspend-ClusterNode")
```powershell
...
```
Configure the quorum to use a node majority, with no witness [Zacker][Zacker]: 320
```powershell
...
```
Configure a cloud witness [Zacker][Zacker]: 348
```powershell
Set-ClusterQuorum -CloudWitness -AccountName clusterstorage1 -AccessKey $accesskey
```
### [Set-DedupVolume][msdocs:Set-DedupVolume]
...
```
### [Add-ClusterScaleOutFileServerRole][msdocs:Add-ClusterScaleOutFileServerRole]
Install the Scale-out File Server role (incorrectly appears as `Add-ClusterScaleOutFileServer` in the text) [Zacker][Zacker]: 339
```powershell
Add-ClusterScaleOutFileServerRole
```
### [Add-ClusterSharedVolume][msdocs:Add-ClusterSharedVolume]
Zacker: 336
```powershell
Add-ClusterSharedVolume -Name "Cluster disk 5"
```
### [Add-ClusterVMMonitoredItem][msdocs:Add-ClusterVMMonitoredItem]
Zacker: 362
```powershell
...
Add storage to a failover cluster [created][New-Cluster] with the `-NoStorage` option [Zacker][Zacker]: 354
```powershell
...
### [Backup-GPO][msdocs:Backup-GPO]
Backup all GPOs [Warren: 167][Warren]
```powershell
...
Close an open file [docs.microsoft.com][https://docs.microsoft.com/en-us/powershell/module/smbshare/close-smbopenfile?view=win10-ps]
```powershell
Close-SmbOpenFile -FileId 4415226383589
```
Close open files for a session [docs.microsoft.com][https://docs.microsoft.com/en-us/powershell/module/smbshare/close-smbopenfile?view=win10-ps]
```powershell
Close-SmbOpenFile -SessionId 4415226380393
```
### [Get-SmbOpenFile][msdocs:Get-SmbOpenFile]
Get information about an opened file [MS Docs][https://docs.microsoft.com/en-us/powershell/module/smbshare/get-smbopenfile?view=win10-ps]
```powershell
Get-SmbOpenFile -FileId 4415226383569 | Select-Object -Property *
```
Get information about a file opened for an SMB client [MS Docs][https://docs.microsoft.com/en-us/powershell/module/smbshare/get-smbopenfile?view=win10-ps]
```powershell
...
### [New-ScheduledTask][msdocs:New-ScheduledTask]
```powershell
$sshaction = New-ScheduledTaskAction -Execute C:\WINDOWS\System32\bash.exe -Argument '-c sudo service ssh start'
$sshtrigger = New-ScheduledTaskTrigger -AtLogon
$sshtask = New-ScheduledTask
```
### [New-ScheduledTaskAction][msdocs:New-ScheduledTaskAction]
```powershell
$sshaction = New-ScheduledTaskAction -Execute C:\WINDOWS\System32\bash.exe -Argument '-c sudo service ssh start'
```
### [New-ScheduledTaskTrigger][msdocs:New-ScheduledTaskTrigger]
```powershell
$sshtrigger = New-ScheduledTaskTrigger -AtLogon
```
...
```
Create a new share with the `Allow Full Control` permission granted to the `Everyone` special identity [Zacker][Zacker]: 106
```powershell
New-SmbShare -Name Data -Path C:\Docs -FullAccess Everyone
```
Create an SoFS share [Zacker][Zacker]: 340
```powershell
...
### [Merge-VHD][msdocs:Merge-VHD]
Merge a differencing disk into its parent disk [Zacker][Zacker]: 228
```powershell
Merge-VHD -Path $OLDFILE -DestinationPath $NEWFILE
```
### [Restore-GPO][msdocs:Restore-GPO]
Restore a GPO [Warren: 168][Warren]
```powershell
Restore-GPO -Name "Sales Managers" -Path \\LON-DC1\Backup
```
### [Restore-VMSnapshot][msdocs:Restore-VMSnapshot]
Apply a checkpoint [Zacker][Zacker]: 230
```powershell
Restore-VMCheckpoint -Name checkpoint1 -VMName server1
```
### [Add-NlbClusterPortRule][msdocs:Add-NlbClusterPortRule]
Create a cluster port rule that ensures that all SSL traffic for a network client computer is routed to the same cluster host after making an initial connection. [MeasureUp][mu:70-740]
```powershell
Get-NlbCluster | Add-NlbClusterPortRule -StartPort 443 -EndPort 443 -Affinity Single
```
### [Add-NlbClusterVip][msdocs:Add-NlbClusterVip]
Used to add a new virtual IP address without changing the cluster primary IP address.
### [New-ClusterFaultDomain][msdocs:New-ClusterFaultDomain]
...
```
### [New-DedupSchedule][msdocs:New-DedupSchedule]
`Days`
`DurationHours`
`Enabled`
`Memory`
...
```
### [Set-ClusterFaultDomain][msdocs:Set-ClusterFaultDomain]
...
```
### [Set-SCVirtualMachine][msdocs:Set-SCVirtualMachine]
`DynamicMemoryEnabled`
`MemoryMB`

Disable dynamic memory on a VM [MeasureUp][mu:70-740]
```powershell
...
```
### [New-IscsiVirtualDisk][msdocs:New-IscsiVirtualDisk]
`Fixed`
`Path`
`SizeBytes`
...
```
### [New-IscsiServerTarget][msdocs:New-IscsiServerTarget]
```powershell
New-IscsiServerTarget -TargetName PLABDC01 -InitiatorId @("DNSName:plabdm01.practicelabs.com","plabsa01.practicelabs.com")
```
### [New-VMSAN][msdocs:New-VMSAN]
**`Name`**

```powershell
New-VMSan "PLABS-Fc"
```
### [Add-VMFibreChannelHBA][msdocs:Add-VMFibreChannelHBA]
**`VMName`**
**`SANName`**
...
```
### [Get-NetFirewallServiceFilter][msdocs:Get-NetFirewallServiceFilter]
`Service`
Enable firewall rules associated with the `msiscsi` service [Practice Lab][pl:70-740]
```powershell
Get-NetFirewallServiceFilter -Service msiscsi | Get-NetFirewallRule | Enable-NetFirewallRule
```
### [Get-ClusterNode][msdocs:Get-ClusterNode]
Configure a cluster node not to have a quorum vote [Zacker][Zacker]: 320
```powershell
...
- [Create a virtual switch with SET enabled](#create-a-virtual-switch-with-set-enabled)70-740
- [Implement nested virtualization](#implement-nested-virtualization)70-740
- [Enable CredSSP](#enable-credssp)70-740
- [Configure Server Core](#configure-server-core)70-740
- [Implement Discrete Device Assignment](#implement-dda)70-740
- [Create a S2D cluster](#configure-s2d-cluster)70-740
- [Configure a pass-through disk](#pass-through-disk)70-740
- [Create a VM, specifying installation media](#create-vm-with-installation-media)70-740
- [Create a scheduled task](#scheduled-task)

#### Computer information
Display computer name 
[devblogs.microsoft.com][https://devblogs.microsoft.com/scripting/powertip-use-powershell-to-get-computer-name/]
```powershell
Get-ComputerInfo -Property CsName
gin.CsName
$Env:computername
...
[Pester](https://pester.dev/docs/quick-start) tests are organized in a hierarchy of blocks:
```powershell
Describe
{
  Context # optional
...
Pester is run with [`Invoke-Pester`](https://www.red-gate.com/simple-talk/sysadmin/powershell/introduction-to-testing-your-powershell-code-with-pester/)
