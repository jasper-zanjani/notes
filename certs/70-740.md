...
Skill                                                       | Links
---                                                         | ---
**1.1** Install, upgrade, and migrate servers and workloads | [Determine Windows Server 2016 installation requirements](#requirements) • [Determine appropriate Windows Server 2016 editions per workloads](#editions) • [Install Windows Server 2016](#installation) • [Install Windows Server 2016 features and roles](#installation) • [Install and configure Windows Server Core](#server-core) • Manage Windows Server Core installations using Windows PowerShell, command line, and remote management capabilities • [Implement PowerShell Desired State Configuration (DSC) to install and maintain integrity of installed environments](#dsc) • [Perform upgrades and migrations of servers and core workloads from Windows Server 2008 and Windows Server 2012 to Windows Server 2016](#upgrading) •  Determine the appropriate activation model for server installation
