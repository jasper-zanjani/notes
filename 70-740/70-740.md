[1.1]: #11-install-upgrade-and-migrate-servers-and-workloads "Install, upgrade and migrate servers and workloads"
...
`Session`
[`et`][Enter-ContainerSession] 
### `-NanoServerImage` cmdlets
[`n` ][New-NanoServerImage] 
[`e` ][Edit-NanoServerImage]
### `-Smb` cmdlets
`ClientConfiguration`
