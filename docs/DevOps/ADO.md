...
- Each **job** runs on an [**agent**](#agent) and can be made of one or more **steps** or **tasks** which are run sequentially.
...
[**Parameters**](https://learn.microsoft.com/en-us/azure/devops/pipelines/process/templates?view=azure-devops#parameters) must contain a name and data type and are dereferenced using the **${{ ... }}** syntax.
