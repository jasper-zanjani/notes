...
#### AAA protocols
- **Remote Authentication Dial-In User Service (RADIUS)** protocol that enables a single server to become responsible for all remote-access authentication, authorization, and auditing services (UDP ports 1812 and 1813, legacy ports 1645 and 1646) [[Dulaney][Dulaney]: 363; [Barrett][Barrett]: 394]
