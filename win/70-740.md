...
[Add-ClusterDisk]: https://github.com/jasper-zanjani/notes/tree/master/win/pwsh.md#add-clusterdisk '```&#10;PS C:\> Add-ClusterDisk&#10;```&#10;Allow an admin to add a new disk to a failover cluster'
[Add-ClusterFileServerRole]: https://github.com/jasper-zanjani/notes/tree/master/win/pwsh.md#add-clusterfileserverrole '```&#10;PS C:\> Add-ClusterFileServerRole&#10;```&#10;This command allows an admin to create a clustered file server'
...
[Add-ClusterGroup]: https://github.com/jasper-zanjani/notes/tree/master/win/pwsh.md#add-clustergroup '```&#10;PS C:\> Add-ClusterGroup&#10;```&#10;Allow an admin to add a resource group to the failover cluster'
[Add-ClusterNode]: https://github.com/jasper-zanjani/notes/tree/master/win/pwsh.md#add-clusternode '```&#10;PS C:\> Add-ClusterNode&#10;```&#10;Allow an admin to add a node to a failover cluster'
[Add-ClusterResource]: https://github.com/jasper-zanjani/notes/tree/master/win/pwsh.md#add-clusterresource '```&#10;PS C:\> Add-ClusterResource&#10;```&#10;Allow an admin to add a resource to a failover cluster'
[Add-ClusterResourceDependency]: https://github.com/jasper-zanjani/notes/tree/master/win/pwsh.md#add-clusterresourcedependency '```&#10;PS C:\> Add-ClusterResourceDependency&#10;```&#10;Add a resource dependency to a failover cluster'
...
[Add-ClusterServerRole]: https://github.com/jasper-zanjani/notes/tree/master/win/pwsh.md#add-clusterserverrole '```&#10;PS C:\> Add-ClusterServerRole&#10;```&#10;Add the cluster server role to a server'
[Block-ClusterAccess]: https://github.com/jasper-zanjani/notes/tree/master/win/pwsh.md#block-clusteraccess '```&#10;PS C:\> Block-ClusterAccess&#10;```&#10;Block the specified users from accessing a cluster'
...
[Get-Cluster]: https://github.com/jasper-zanjani/notes/tree/master/win/pwsh.md#get-cluster '```&#10;PS C:\> Get-Cluster&#10;```&#10;Display information about a failover cluster'
[Get-ClusterAccess]: https://github.com/jasper-zanjani/notes/tree/master/win/pwsh.md#get-clusteraccess '```&#10;PS C:\> Get-ClusterAccess&#10;```&#10;Display permissions for a failover cluster'
[Get-ClusterNode]: https://github.com/jasper-zanjani/notes/tree/master/win/pwsh.md#get-clusternode '```&#10;PS C:\> Get-ClusterNode&#10;```&#10;Display information about the servers in a failover cluster'
[Get-ClusterQuorum]: https://github.com/jasper-zanjani/notes/tree/master/win/pwsh.md#get-clusterquorum '```&#10;PS C:\> Get-ClusterQuorum&#10;```&#10;Display cluster quorum in a cluster'
[New-Cluster]: https://github.com/jasper-zanjani/notes/tree/master/win/pwsh.md#new-cluster '```&#10;PS C:\> New-Cluster&#10;```&#10;Create a new failover cluster'
[Remove-Cluster]: https://github.com/jasper-zanjani/notes/tree/master/win/pwsh.md#remove-cluster '```&#10;PS C:\> Remove-Cluster&#10;```&#10;Remove a failover cluster'
[Remove-ClusterAccess]: https://github.com/jasper-zanjani/notes/tree/master/win/pwsh.md#remove-clusteraccess '```&#10;PS C:\> Remove-ClusterAccess&#10;```&#10;Remove user access from the cluster'
[Remove-ClusterNode]: https://github.com/jasper-zanjani/notes/tree/master/win/pwsh.md#remove-clusternode '```&#10;PS C:\> Remove-ClusterNode&#10;```&#10;Remove a node from a failover cluster'
[Start-Cluster]: https://github.com/jasper-zanjani/notes/tree/master/win/pwsh.md#start-cluster '```&#10;PS C:\> Start-Cluster&#10;```&#10;Start the Cluster service on all nodes'
[Stop-Cluster]: https://github.com/jasper-zanjani/notes/tree/master/win/pwsh.md#stop-cluster '```&#10;PS C:\> Stop-Cluster&#10;```&#10;Stop the Cluster service on all nodes'
[Stop-ClusterNode]: https://github.com/jasper-zanjani/notes/tree/master/win/pwsh.md#stop-clusternode '```&#10;PS C:\> Stop-ClusterNode&#10;```&#10;Stop the Cluster service on a node'
...
[Test-Cluster]: https://github.com/jasper-zanjani/notes/tree/master/win/pwsh.md#test-cluster '```&#10;PS C:\> Test-Cluster&#10;```&#10;Complete validation tests for a cluster'
...
<!-- Hyper-V cmdlets -->
[Move-VM]: https://github.com/jasper-zanjani/notes/tree/master/win/pwsh.md#move-vm '```&#10;PS C:\> Move-VM&#10;```&#10;Moves a virtual machine to a new Hyper-V host.'
...
[Remove-VMNetworkAdapter]: https://github.com/jasper-zanjani/notes/tree/master/win/pwsh.md#remove-vmnetworkadapter '```&#10;PS C:\> Remove-VMNetworkAdapter&#10;```&#10;Removes one or more virtual network adapters from a virtual machine.'
